# Getting help with datawrap

Thanks for using datawrap! Before filing an issue, there are a few
...
- If it’s a question: It’s best to ask on the [R4DS Online Learning
  Community Slack](https://r4ds.io/join). Other options include [Posit
  Community](https://community.rstudio.com/), and StackOverflow. There
  are more people there to answer questions.

- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/wranglezone/datawrap/issues/new).
...
requests](https://github.com/wranglezone/datawrap/issues) to make sure
...
We’ll try to look at your issue as soon as we can, but these packages
are maintained by volunteers. A good reprex is particularly important
because it might be weeks or months between your initial report and when
we start working on it. If we can’t reproduce the bug, we can’t fix it!
