...
**datawrap** — Final Steps for Dataset Preparation

Helpers to create data dictionaries, document package datasets, and apply finishing touches to data for distribution.

Package website: https://wranglezone.github.io/datawrap/
This repo: https://github.com/wranglezone/datawrap
...
datawrap/
├── R/                          # R source code
│   ├── datawrap-package.R # Auto-generated package docs
